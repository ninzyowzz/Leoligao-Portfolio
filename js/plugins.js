$(document).ready(function(){
	...
	// function swap_this(){
	// 	if(window_width <= 800){
	// 		$('.right_box1').insertAfter('.left_box2');
	// 		$('.right_box2').insertAfter('.left_box1');
	// 	} else {
	// 		$('.right_box1').insertAfter('.left_box1');
	// 		$('.right_box2').insertAfter('.left_box2');
	// 	}
	// }
	...
	$('.tab_nav a').click(function (e) {
		...
		$(target).fadeIn(3000); // Show the content div corresponding to the clicked link

		$('.tab_nav a').removeClass('selected'); // Remove 'selected' class from all links
